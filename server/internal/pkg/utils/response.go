...
func (r *Response) JSONResponse(c echo.Context, statusCode int, data interface{}, message string, err interface{}) error {
...
func (r *Response) BadRequestResponse(c echo.Context, err interface{}) error {
...
func (r *Response) CustomResponse(c echo.Context, statusCode int, data interface{}, message string, err interface{}) error {
...
// GoneResponse is a helper for HTTP 410 Gone responses.
func (r *Response) GoneResponse(c echo.Context, err string) error {
	return r.JSONResponse(c, http.StatusGone, nil, "", err)
}
